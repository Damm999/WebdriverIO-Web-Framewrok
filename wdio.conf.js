const debug = process.env.DEBUG ? 9999999 : 10000;
...
exports.config = {
    ...
    reporters: ['spec', 'dot', 'concise', [HtmlReporter, {
        debug: true,
        ...
        ['junit', {
            ...
            outputFileFormat: function (options) { // optional
                ...
                const timestamp = moment().format('YYYY-MM-DD-HHmmss.SSS');
                return 'results-'+timestamp+'.xml'
            }
        }],
        ['json', {
            stdout: false,
    ...
    onPrepare: function (config, capabilities) {
        ...
        del.sync(['allure-report','reports/allure-results/'])
    },
    /**
    ...
    before: function (capabilities, specs) {
        ...
        chai = require('chai');
        chaiassert = chai.assert;    // Using Assert style
        //  expect = chai.expect;    // Using Expect style
        should = chai.should();  // Using Should style
        require('@babel/register');

        
    // Add Command..

browser.addCommand('submitContactUs', function (firstName, lastName, emailAddress,comments) {
    if(firstName)
...
browser.addCommand('isVideoPaused',function(){
    ...
    var isPaused = browser.execute(function(){
        console.log("Outputted inside browser console window.");
